...
- Truy cập repo github vừa tạo và upload cả folder vừa sửa lên Github
...
- Sau khi login thành công gõ lệnh "npm publish --access public" để public package lên npm publish. 
